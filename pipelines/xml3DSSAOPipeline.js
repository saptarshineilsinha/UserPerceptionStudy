...
(function (webgl) {
    ...
    var SSAOPass1 = function (renderInterface, output, opt) {
        ...
        var context = this.renderInterface.context;
        this._program = context.programFactory.getProgramByName("ssaoXml3D");
...
//                this.updateUniforms();
        ...
        _setNonVolatileShaderUniforms: (function () {
            ...
            return function (scene) {
                ...
                //xml3D ssao parameters
                uniforms["uScale"] = window.uscale;
                uniforms["uBias"] = window.bias;
                uniforms["uIntensity"] = window.intensity;
                uniforms["uSampleRadius"] = window.radius_ssao;
